...
class Utility(object):
    ...
    @classmethod
    def log_stdout(cls, message, component="TD_Connections"):
        """Log messages to stdout.

        Args:
            message(str): Message to be logged to stdout.
            component(str): Component name. Defaults to "TD_Connections".
        """
    ...
    @classmethod
    def log_stderr(cls, message, component="TD_Connections"):
